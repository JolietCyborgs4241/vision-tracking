...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__cv_threshold_thresh = 0.0
        ...
        self.__normalize_alpha = 25.0
        self.__normalize_beta = 255.0

        self.normalize_output = None

        self.__hsv_threshold_input = self.normalize_output
        self.__hsv_threshold_hue = [0.0, 86.95187165775404]
        self.__hsv_threshold_saturation = [19.2090395480226, 75.45454545454545]
        self.__hsv_threshold_value = [0.0, 57.27272727272727]
        ...
        self.__filter_contours_max_ratio = 8.0
